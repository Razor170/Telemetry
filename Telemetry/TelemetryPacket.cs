...
namespace Telemetry
{
    ...
    public struct TelemetryPacket : ISerializable
    {
        public TelemetryPacket(SerializationInfo info, StreamingContext context)
        {
            ...
            Anti_Lock_Breakes = info.GetValue<float>("Anti_Lock_Breakes");
            ...
            brake_temp = info.GetValue<float>("brake_temp");
            wheels_pressure = info.GetValue<float>("wheels_pressure");
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("brake_temp", brake_temp);
            info.AddValue("wheels_pressure", wheels_pressure);
